...
describe("Check the sceme of the source", function () {
...
describe("Check the information from the API", function () {

    it("Return from homepage should be text", function (done) {
    ...
    it("Return from currenttemp page should be number", function (done) {
        ...
        server
            ...
            .end(function (err, res) {
                // HTTP status should be 200
                console.log(res.body.currentTemp);
